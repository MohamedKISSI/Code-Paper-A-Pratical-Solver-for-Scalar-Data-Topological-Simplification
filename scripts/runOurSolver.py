...
tTKTopologicalOptimization1.Semidirectmatch = 1
tTKTopologicalOptimization1.LazyDiscretGradientUpdate = 1
...
# save data
SaveData(f'./../results/optimizedDataOurSolver.vti', proxy=tTKTopologicalOptimization1, ChooseArraysToWrite=1, PointDataArrays=['Id Block', 'Result', 'Last Change', 'Modification Number'])
