...
data = XMLImageDataReader(registrationName='optimizedDataOurSolver.vti', FileName=['./../results/optimizedDataOurSolver.vti'])
...
tTKLDistance1.ScalarField1 = ['POINTS', 'initialData']
...
tTKLDistance1.pparameter = 'inf'
tTKLDistance1.Outputname = 'Linf-distance'
