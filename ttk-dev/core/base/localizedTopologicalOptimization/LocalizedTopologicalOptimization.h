/// \ingroup base
/// \class ttk::LocalizedTopologicalOptimization
...
namespace ttk {
  namespace lto {
    ...
    class LocalizedTopologicalOptimization : virtual public Debug {
    ...
    public:
      ...
      LocalizedTopologicalOptimization() {
        this->setDebugMsgPrefix("LTS");
      }
      ~LocalizedTopologicalOptimization() override = default;
      ...
      int allocateMemory(std::vector<IT> &segmentation,
                         ...
                         std::vector<ttk::lts::Propagation<IT> *> &propagationMask,
      ...
      int initializeMemory(IT *segmentation,
                           IT *queueMask,
                           IT *localOrder,
                           ttk::lts::Propagation<IT> **propagationMask,
...
#pragma omp parallel for num_threads(this->threadNumber_)
      ...
      int initializePropagations(
        std::vector<ttk::lts::Propagation<IT>> &propagations,
...
#pragma omp parallel for num_threads(this->threadNumber_)
      ...
      int computeSimplePropagation(
        ttk::lts::Propagation<IT> &propagation,
        ttk::lts::Propagation<IT> **propagationMask,
...
#pragma omp atomic capture
            ...
            std::vector<ttk::lts::Propagation<IT> *> neighborPropagations(
              nNeighbors, nullptr);
            for(IT n = 0; n < nNeighbors; n++) {
              IT u{-1};
              triangulation->getVertexNeighbor(v, n, u);
...
#pragma omp atomic capture
      ...
      /// propagations.
      template <typename IT, class TT>
      int computeSimplePropagations(std::vector<ttk::lts::Propagation<IT>> &propagations,
                                    ttk::lts::Propagation<IT> **propagationMask,
                                    IT *segmentation,
                                    IT *queueMask,
...
#pragma omp parallel for schedule(dynamic, 1) num_threads(this->threadNumber_)
      ...
      template <typename IT>
      int
        finalizePropagations(std::vector<ttk::lts::Propagation<IT> *> &parentPropagations,
                             std::vector<ttk::lts::Propagation<IT>> &propagations,
...
#pragma omp parallel for schedule(dynamic) num_threads(this->threadNumber_)
      ...
      int computeLocalOrderOfSegment(IT *localOrder,
                                     ...
                                     const ttk::lts::Propagation<IT> *propagation,
                                     const TT *triangulation,
                                     const IT *segmentation,
                                     const IT *inputOrder) const {
      ...
      int computeLocalOrderOfSegments(
        ...
        const IT *segmentation,
        const IT *inputOrder,
        const std::vector<ttk::lts::Propagation<IT> *> &propagations) const {
        ttk::Timer timer;
...
#pragma omp parallel for num_threads(this->threadNumber_)
      ...
      int flattenOrder(
        IT *outputOrder,
        const std::vector<ttk::lts::Propagation<IT> *> &parentPropagations) const {
...
#pragma omp parallel for num_threads(this->threadNumber_)
      ...
      int flattenScalars(DT *scalars,
                         const std::vector<ttk::lts::Propagation<IT>> &propagationsA,
                         const std::vector<ttk::lts::Propagation<IT>> &propagationsB
                         = {}) const {
        ...
        std::vector<const std::vector<ttk::lts::Propagation<IT>> *> propagationsPair
...
#pragma omp parallel for num_threads(this->threadNumber_)
      ...
      int detectAndRemoveUnauthorizedMaxima(
        ...
        std::vector<ttk::lts::Propagation<IT> *> parentPropagations;
        status
...
#pragma omp parallel for num_threads(this->threadNumber_)
      ...
      int removeUnauthorizedExtrema(DT *scalars,
        ...
        std::vector<IT> localOrder;
        std::vector<ttk::lts::Propagation<IT> *> propagationMask;
        std::vector<ttk::lts::Propagation<IT>> propagationsMax;
        std::vector<ttk::lts::Propagation<IT>> propagationsMin;
        std::vector<std::tuple<IT, IT, IT>> sortedIndices;
