/// \ingroup base
/// \class ttk::LocalizedSignedDistanceField
...
namespace ttk {
  namespace lto {
    ...
    class LocalizedSignedDistanceField : virtual public Debug {
    ...
    public:
      ...
      LocalizedSignedDistanceField() {
        this->setDebugMsgPrefix("LTS");
      }
      ~LocalizedSignedDistanceField() override = default;
